...
In order to test out and use the classes in this repo you have to do a little setting-up.
 ...
 1. Install an IDE (Integrated Development Environment) for Java. I recommend **[IntelliJ IDEA](https://www.jetbrains.com/idea/)**, but you can also opt for **[Eclipse IDE](https://www.eclipse.org/)** or **[NetBeans IDE](https://netbeans.apache.org/)**.
...
Allt ska finnas i **`src`** mappen. Resten av filerna är **IntelliJ IDEA** projektfiler
...
För att kunna testa och använda klasserna i detta repo måste du göra lite set-ups.

1. Installera en IDE (Integrated Development Enviroment) för Java. Jag rekommenderar **[IntelliJ IDEA](https://www.jetbrains.com/idea/)**, men du kan också använda **[Eclipse IDE](https://www.eclipse.org/)** eller **[NetBeans IDE](https://netbeans.apache.org/)**.

2. När du har installerat det måste du ställa in ett nytt projekt med ett arbetsmiljö. I detta repo har jag använt **Java 8**, så något nyare än det skulle fungera (**Nuvarande version är Java 17**).

3. Därefter kan du lägga alla filerna från **`src`** i din egen **`src`** mapp.

4. För att testa klasserna i repoet är det väldigt enkelt. Gå bara till **`Main.java`** klassen och avkommentera **metoden** för **klassen** du vill testa.

![Main Class in IntelliJ IDEA](/screenshots/mainclassscreen.png)

5. Filstrukturen bör se ut ungefär så här.
